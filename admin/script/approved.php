...
if (isset($_GET['delete_id'])) {
    ...
    if ($stmt_delete->execute()) {
        header("Location: approved.php"); // Refresh the page after deletion
        exit;
    } else {
...
<div class="main-container">
    ...
    <div class="container container-two">
        ...
        <table>
            ...
            <tbody>
                <?php
                $sn = $offset + 1; // Serial number starts from offset
                while ($row = mysqli_fetch_assoc($result_rent)) {
                    ...
                    echo "<td><button class='status-btn'>Approved</button></td>";
                    echo "<td>
